...
public class ValutaMain {
    ...
    private static Valuta EUR = new Valuta(10.1208, "EURO"); //Lager et nytt tilfelle av valuta og gir den en kurs og navn
    private static Valuta SEK = new Valuta(0.9966, "SEK"); //Lager et nytt tilfelle av valuta og gir den en kurs og navn
    private static Valuta USD =  new Valuta(8.5915, "USD"); //Lager et nytt tilfelle av valuta og gir den en kurs og navn
